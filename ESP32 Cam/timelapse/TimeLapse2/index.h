...
<html>
    ...
    <body>
        <section class="main">
            <div id="logo">
                <label for="nav-toggle-cb" id="nav-toggle">☰&nbsp;&nbsp;Toggle Camera settings - Timelapse Status: </label>
                <input type="text" id="lapseRunning" class="default-action" readonly="" style="width: 10px;">
            </div>
            <div id="content">
                <div id="sidebar">
                    ...
                    <nav id="menu">
                        ...
                        <div class="input-group" id="interval-group">
                            ...
                            <input type="number" id="interval" min="0" max="1000000000" value="3000" class="default-action">
                        </div>
                        <div id="sd-group">
                            <label for="sd_tot">SD - Total Space MB </label>
                            <input type="text" id="sd_tot" class="default-action" readonly="" style="width: 50px;">
                            <label for="sd_used">Used Space MB </label>
                            <input type="text" id="sd_used" class="default-action" readonly="" style="width: 50px;">
                        </div>
                        <section id="buttons">
